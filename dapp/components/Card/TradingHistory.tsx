...
const TradingHistory = (props:any) => {
    ...
    const getHistory = async () => {
        const data = await fetch(`https://api.covalenthq.com/v1/97/tokens/0x50B5BdBeaCeDe6AEB22d1C2b4A8A37a1A1FD71E9/nft_transactions/${props.tokenId}/?&key=ckey_08290dd811f54239a7d5ac20831`);
